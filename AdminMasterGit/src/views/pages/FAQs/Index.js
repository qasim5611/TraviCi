...
export default function (props) {
  ...
  const token = window.sessionStorage.getItem("creatturAccessToken");
  ...
  return (
    ...
    >
      <Box mb={5}>
        <Box style={{ display: "flex", justifyContent: "space-between" }} className={classes.headingBox} pb={2}>
          <Typography variant="h3" style={{ marginBottom: "8px" }}>
            <strong> FAQs</strong>
          </Typography>
          <RouterLink to="/add-faq" style={{ textDecoration: "none" }}>
